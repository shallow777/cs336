...
def run_multihead_self_attention(
    ...
    causal_multi_head_attention = CausalMultiHeadAttention(d_model, num_heads, device = in_features.device, dtype = in_features.dtype)
...
def run_multihead_self_attention_with_rope(
    ...
    """
    from cs336_basics.model import CausalMultiHeadAttention
    causal_multi_head_attention = CausalMultiHeadAttention(d_model, num_heads, theta, max_seq_len)
    causal_multi_head_attention.q_proj.weight.data = q_proj_weight
    causal_multi_head_attention.k_proj.weight.data = k_proj_weight
    causal_multi_head_attention.v_proj.weight.data = v_proj_weight
    causal_multi_head_attention.o_proj.weight.data = o_proj_weight
